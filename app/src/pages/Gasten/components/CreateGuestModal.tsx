...
const CreateGuestModal: React.FC<CreateGuestModalProps> = ({ isOpen, setIsOpen, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError('Kon gast niet aanmaken');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            >
                <h2 className="text-2xl font-semibold mb-6">Nieuwe Gast</h2>
